...
public interface RulesMapper extends CommonCountMapper, CommonDeleteMapper, CommonUpdateMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-03-27T15:17:00.3232243+01:00", comments="Source Table: dumb_brms.rules")
    BasicColumn[] selectList = BasicColumn.columnList(ruleId, projectId, salience, ruleName, isActive);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-03-27T15:17:00.3202255+01:00", comments="Source Table: dumb_brms.rules")
    @InsertProvider(type=SqlProviderAdapter.class, method="insert")
    @Options(useGeneratedKeys=true,keyProperty="row.ruleId")
    int insert(InsertStatementProvider<Rules> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-03-27T15:17:00.3222236+01:00", comments="Source Table: dumb_brms.rules")
