...
public interface ProjectsMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<Projects>, CommonUpdateMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-01-31T08:57:36.483187+01:00", comments="Source Table: dumb_brms.projects")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-01-31T08:57:36.4821879+01:00", comments="Source Table: dumb_brms.projects")
    default int deleteByPrimaryKey(Long id_, Long userId_) {
        return delete(c -> 
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-01-31T08:57:36.483187+01:00", comments="Source Table: dumb_brms.projects")
    default Optional<Projects> selectByPrimaryKey(Long id_, Long userId_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
            .and(userId, isEqualTo(userId_))
        );
    ...
    default int updateByPrimaryKey(Projects row) {
        return update(c ->
            c.set(projectName).equalTo(row::getProjectName)
            .set(lastUpdate).equalTo(row::getLastUpdate)
            .set(creationDatetime).equalTo(row::getCreationDatetime)
            .where(id, isEqualTo(row::getId))
            .and(userId, isEqualTo(row::getUserId))
        );
    }
    ...
    default int updateByPrimaryKeySelective(Projects row) {
        return update(c ->
            c.set(projectName).equalToWhenPresent(row::getProjectName)
            .set(lastUpdate).equalToWhenPresent(row::getLastUpdate)
            .set(creationDatetime).equalToWhenPresent(row::getCreationDatetime)
            .where(id, isEqualTo(row::getId))
            .and(userId, isEqualTo(row::getUserId))
