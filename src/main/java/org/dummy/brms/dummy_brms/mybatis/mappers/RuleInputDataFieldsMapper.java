...
public interface RuleInputDataFieldsMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<RuleInputDataFields>, CommonUpdateMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-02-03T19:20:13.9475597+01:00", comments="Source Table: dumb_brms.rule_input_data_fields")
    BasicColumn[] selectList = BasicColumn.columnList(ridFieldName, ridClass, ridFieldType);
    ...
    @Results(id="RuleInputDataFieldsResult", value = {
        ...
        @Result(column="rid_class", property="ridClass", jdbcType=JdbcType.VARCHAR),
        @Result(column="rid_field_type", property="ridFieldType", jdbcType=JdbcType.VARCHAR)
    })
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-02-03T19:20:13.9475597+01:00", comments="Source Table: dumb_brms.rule_input_data_fields")
    default int deleteByPrimaryKey(String ridFieldName_) {
        return delete(c -> 
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-02-03T19:20:13.9475597+01:00", comments="Source Table: dumb_brms.rule_input_data_fields")
    default Optional<RuleInputDataFields> selectByPrimaryKey(String ridFieldName_) {
        return selectOne(c ->
            c.where(ridFieldName, isEqualTo(ridFieldName_))
        );
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-02-03T19:20:13.9475597+01:00", comments="Source Table: dumb_brms.rule_input_data_fields")
    default int updateByPrimaryKey(RuleInputDataFields row) {
        return update(c ->
            c.set(ridClass).equalTo(row::getRidClass)
            .set(ridFieldType).equalTo(row::getRidFieldType)
            .where(ridFieldName, isEqualTo(row::getRidFieldName))
        );
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-02-03T19:20:13.9475597+01:00", comments="Source Table: dumb_brms.rule_input_data_fields")
    default int updateByPrimaryKeySelective(RuleInputDataFields row) {
        return update(c ->
            c.set(ridClass).equalToWhenPresent(row::getRidClass)
            .set(ridFieldType).equalToWhenPresent(row::getRidFieldType)
            .where(ridFieldName, isEqualTo(row::getRidFieldName))
        );
    }
