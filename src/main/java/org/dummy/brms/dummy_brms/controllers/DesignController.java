...
public class DesignController {
    ...
    public PostedResourceDTO addRuleInputData(Authentication authentication, @RequestBody ProjectDTO project) throws DummyBadRequestException {
        return projectsService.postProject(project, (UserDTO) authentication.getPrincipal());
    }

    @GetMapping(value = "/getRuleInputData", produces = "application/json")
    @PreAuthorize("hasRole('USER')")
    public List<ProjectResponseDTO> getRuleInputData(Authentication authentication) {
